...
def train_step(auto_encoder, discriminator, x, y, ae_optimizer, disc_optimizer):
    ...
    disc_loss = 1.0 # discriminator_loss(real_output, fake_output, 1)
    gen_loss = 1.0 # generator_loss(fake_output, 1)
...
def train_model(auto_encoder, discriminator, train_dataset, ae_optimizer, disc_optimizer, epochs):
